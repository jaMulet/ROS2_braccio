...
public:
  ...
  */
  ...
  /**
   * This function allow the user to control all the servo motors in the Braccio (ORIGINAL VERSION)
   */
  int ServoMovement_ini(int delay, int Vbase,int Vshoulder, int Velbow, int Vwrist_ver, int Vwrist_rot, int Vgripper); 

  /**
   * This function allow the user to control all the servo motors in the Braccio
   */
  int ServoMovement(int Vbase,int Vshoulder, int Velbow, int Vwrist_ver, int Vwrist_rot, int Vgripper); 
